...
This local verification combines the existing 19-source [September 12 hosted run](https://github.com/BD4L/breach-dashboard-v2/actions/runs/34698401186) with bounded new-source requests on September 12, 15:06-15:17 UTC. Durable baseline: `collection-state` commit `96b9f0dcbeb577bb28d42b50cc3540675dbada45`. The merge preserved all 28,197 earlier report IDs and first-seen timestamps. Counts below are latest accepted rows, not distinct incidents or total retained history.

Local outcomes: 24 complete/unchanged, 22 limited, 2 failed, 3 reference-only. Hosted access is verified separately after release.
...
| [BankInfoSecurity.com](https://www.bankinfosecurity.com/rssFeeds.php?type=main) (`news_bankinfosecurity`) | Limited coverage | 3 | 2026-09-11 |
| [BleepingComputer](https://www.bleepingcomputer.com/feed/) (`news_bleepingcomputer`) | Complete current window | 4 | 2026-09-11 |
...
| [Dark Reading](https://www.darkreading.com/rss.xml) (`news_darkreading`) | Complete current window | 2 | 2026-09-01 |
| [DataBreaches.net](https://databreaches.net/feed/) (`news_databreaches`) | Complete current window | 7 | 2026-09-11 |
| [DataBreachToday.com](https://www.databreachtoday.com/rssFeeds.php?type=main) (`news_databreachtoday`) | Complete current window | 2 | 2026-09-11 |
...
| [HealthcareInfoSecurity.com](https://www.healthcareinfosecurity.com/rssFeeds.php?type=main) (`news_healthcareinfosecurity`) | Limited coverage | 3 | 2026-09-11 |
...
| [InfoRiskToday.com](https://www.inforisktoday.com/rssFeeds.php?type=main) (`news_inforisktoday`) | Complete current window | 2 | 2026-09-11 |
...
| [Montana](https://dojmt.gov/office-of-consumer-protection/reported-data-breaches/) (`montana`) | Unchanged current window | 6659 | 2026-05-15 |
...
| [RansomLook](https://www.ransomlook.io/) (`ransomlook`) | Limited coverage | 39 | 2026-09-12 |
...
| [Reddit r/databreaches](https://www.reddit.com/r/databreaches.rss) (`reddit_databreaches`) | Failed | 0 | Unknown / no matched report |
...
| [Security Magazine Cybersecurity](https://www.securitymagazine.com/rss/topic/2236-cybersecurity-news) (`news_securitymagazine`) | Complete current window | 8 | 2026-09-11 |
...
| [The Hacker News](https://feeds.feedburner.com/TheHackersNews) (`news_hackernews`) | Complete current window | 4 | 2026-09-12 |
...
- **reddit_databreaches:** HTTP 429 in the bounded local run; an earlier public response contained entries only through April 2024. No reliable current coverage.
...
- **news_healthcareinfosecurity:** Two article byline dates recovered; one matching entry remains undated. No feed build time or invented timestamp.
- **news_bankinfosecurity:** Two article byline dates recovered; one matching entry remains undated. No feed build time or invented timestamp.
- **news_databreachtoday:** Publication dates recovered from article bylines because RSS omits them; day precision retained.
- **news_inforisktoday:** Publication dates recovered from article bylines because RSS omits them; day precision retained.
